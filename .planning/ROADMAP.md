...
**Plans**: 6 plans
  ...
  - [x] 05-05-PLAN.md — Compat matrix: docs/COMPATIBILITY.md with 8-row skeleton + 9-step testing protocol + re-run triggers; human-verify checkpoint for row-filling (REL-04)
  - [x] 05-06-PLAN.md — Release smoke: docs/RELEASE-SMOKE.md with 9-step protocol; automated Step 1 (clean build + jsoup relocation check); human-verify checkpoint for Steps 2-9 on clean dedicated server (REL-05)
**UI hint**: no
